...
return [
    ...
    |
    */
    'navigation_group' => env('TICKETING_NAV_GROUP', 'Support'),
    ...
    */
    'navigation_visibility' => [
        'field' => env('TICKETING_NAV_FIELD', 'is_admin'),
        'allowed' => (function () {
            $raw = array_filter(
                array_map('trim', explode(',', env('TICKETING_NAV_ALLOWED', '1')))
            );
            ...
            $serialized = array_map('serialize', $allowed);
            $unique = array_values(array_unique($serialized));
