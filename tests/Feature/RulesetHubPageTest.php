...
class RulesetHubPageTest extends TestCase
{
    ...
    public function test_section_page_mounts_only_the_requested_tab_component(): void
    {
        ...
        $tablesResponse->assertSee('mx-auto flex items-center justify-center gap-2', false);
        $tablesResponse->assertSee('inline-flex items-center justify-center rounded-full px-4 py-2', false);
