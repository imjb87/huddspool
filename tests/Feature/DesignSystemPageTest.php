...
class DesignSystemPageTest extends TestCase
{
    ...
    public function test_admin_users_can_view_the_design_system_page(): void
    {
        ...
        $this->actingAs($admin)
            ...
            ->assertSeeText('Rows inside the card should be separated with standard dividers, using neutral-800 in dark mode.')
            ->assertSeeText('If a card row is linked, it gets a desktop hover state, resolving to neutral-800 in dark mode.')
