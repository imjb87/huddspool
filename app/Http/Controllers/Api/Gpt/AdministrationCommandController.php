...
class AdministrationCommandController extends Controller
{
    private const COMMANDS = [
        ...
        'create_venue' => ['POST', '/api/gpt/venues'], 'update_venue' => ['PATCH', '/api/gpt/venues/{venue}'], 'add_team_to_section' => ['POST', '/api/gpt/sections/{section}/teams'], 'set_points_deduction' => ['PATCH', '/api/gpt/section-teams/{sectionTeam}/deduction'], 'withdraw_team' => ['POST', '/api/gpt/section-teams/{sectionTeam}/withdraw'], 'replace_section_team' => ['POST', '/api/gpt/section-teams/{sectionTeam}/replace-team'],
        ...
        'reschedule_fixture' => ['POST', '/api/gpt/fixtures/{fixture}/date'], 'set_fixture_venue' => ['POST', '/api/gpt/fixtures/{fixture}/venue'], 'correct_result' => ['POST', '/api/gpt/results/{result}/correction'],
