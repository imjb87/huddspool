...
class AdminResourceReader
{
    ...
    public function definitions(): array
    {
        return [
            ...
            'rulesets' => $this->definition(Ruleset::class, ['id', 'name', 'slug', 'content'], ['name', 'slug'], [], 'Competition rulesets.'),
            'knockouts' => $this->definition(Knockout::class, ['id', 'season_id', 'name', 'slug', 'type', 'best_of', 'entry_fee'], ['name', 'slug'], ['season'], 'Knockout competitions.'),
            'knockout-rounds' => $this->definition(KnockoutRound::class, ['id', 'knockout_id', 'name', 'position', 'scheduled_for', 'best_of', 'is_visible'], ['name'], ['knockout'], 'Knockout rounds and deadlines.'),
            'knockout-participants' => $this->definition(KnockoutParticipant::class, ['id', 'knockout_id', 'label', 'seed', 'team_id', 'player_one_id', 'player_two_id'], ['label'], ['knockout', 'team', 'playerOne', 'playerTwo'], 'Knockout entrants.'),
            'knockout-matches' => $this->definition(KnockoutMatch::class, ['id', 'knockout_id', 'knockout_round_id', 'position', 'home_participant_id', 'away_participant_id', 'winner_participant_id', 'venue_id', 'forfeit_participant_id', 'forfeit_reason', 'referee', 'starts_at', 'home_score', 'away_score', 'best_of', 'completed_at'], ['referee'], ['round', 'homeParticipant', 'awayParticipant', 'winner', 'venue'], 'Knockout matches and outcomes.'),
            ...
            'expulsions' => $this->definition(Expulsion::class, ['id', 'season_id', 'expellable_type', 'expellable_id', 'reason', 'date'], ['reason'], ['season', 'expellable'], 'Player and team expulsions.'),
            'news' => $this->definition(News::class, ['id', 'title', 'slug', 'content', 'published_at', 'author_id', 'created_at'], ['title', 'slug'], ['author'], 'News posts and publication status.'),
            ...
            'support-tickets' => $this->definition(Ticket::class, ['id', 'ticket_uid', 'user_id', 'assignee_id', 'department_id', 'ticket_status_id', 'priority', 'custom_fields', 'last_activity_at', 'created_at'], ['ticket_uid'], ['requester', 'assignee', 'department', 'status'], 'Support tickets and their current assignment and status.'),
            'media' => $this->definition(Media::class, ['id', 'model_type', 'model_id', 'collection_name', 'name', 'file_name', 'mime_type', 'disk', 'size', 'created_at'], ['name', 'file_name'], [], 'Uploaded media records.'),
        ];
    }
