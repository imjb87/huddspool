...
class AdminResourceReader
{
    ...
    public function definitions(): array
    {
        return [
            ...
            'fixtures' => $this->definition(Fixture::class, ['id', 'season_id', 'section_id', 'home_team_id', 'away_team_id', 'fixture_date', 'venue_id', 'ruleset_id', 'week', 'updated_at'], [], ['season', 'section', 'homeTeam', 'awayTeam', 'venue', 'result'], 'League fixtures.'),
