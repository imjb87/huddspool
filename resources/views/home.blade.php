    ...
    <section class="bg-white py-8 sm:py-10" data-home-live-scores>
        <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-6">
            ...
            @if ($liveScores->isEmpty())
                <div class="mt-6 rounded-[1.75rem] border border-dashed border-gray-300 bg-gray-50 px-6 py-10 text-center">
                    <p class="text-sm font-semibold text-gray-900">No current matches in progress right now.</p>
        ...
        @if ($liveScores->isNotEmpty())
            <div class="mt-6 w-full overflow-hidden border-y border-gray-200 bg-white shadow-md" data-home-live-scores-shell>
                <div class="min-w-full overflow-hidden">
                    <div class="bg-linear-to-b from-gray-50 to-gray-100">
                        <div class="mx-auto flex w-full max-w-4xl" data-home-live-scores-band>
                            <div class="w-[40%] py-2 pl-4 text-right text-sm font-semibold text-gray-900 sm:pl-6">
                                Home
                            </div>
                            <div class="w-[20%] px-1 py-2 text-center text-sm font-semibold text-gray-900"></div>
                            <div class="w-[40%] py-2 pr-4 text-left text-sm font-semibold text-gray-900 sm:pr-6">
                                Away
                            </div>
                        </div>
                    </div>
