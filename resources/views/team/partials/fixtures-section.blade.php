<section class="ui-section" data-team-fixtures-section>
    <div class="ui-shell-grid">
        ...
        <div class="lg:col-span-2">
            <div class="ui-card">
                <div class="divide-y divide-gray-200 dark:divide-zinc-700/75">
                    @foreach ($fixtureRows as $fixtureRow)
                        <div wire:key="team-fixture-{{ $fixtureRow->fixture_id }}">
                            @if ($fixtureRow->row_url)
                                <a href="{{ $fixtureRow->row_url }}" class="block py-4 transition sm:-mx-3 sm:-my-px sm:rounded-lg sm:px-3 sm:hover:bg-gray-200/70 dark:sm:hover:bg-zinc-800/70">
                            @endif
