<div class="bg-white shadow-sm sm:rounded-lg p-6 space-y-6">
    ...
    <form wire:submit.prevent="submit" class="space-y-6">
        <div class="grid grid-cols-1 gap-y-4 sm:grid-cols-2 sm:gap-x-6">
            <div>
                ...
                <input type="number" min="0" wire:model="homeScore"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-xs focus:border-green-600 focus:ring-green-600">
                @error('homeScore')
        ...
        <div class="flex justify-end">
            <button type="submit"
                class="inline-flex items-center rounded-md bg-green-700 px-4 py-2 text-sm font-semibold text-white shadow-xs hover:bg-green-600 focus-visible:outline-solid focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-700">
                Submit result
            </button>
        </div>
    </form>
