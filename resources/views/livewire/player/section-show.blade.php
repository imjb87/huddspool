            ...
            <div class="min-w-full overflow-hidden">
                <div class="bg-gray-50 flex">
                    <div class="flex w-1/2 pl-4 sm:pl-6">
                        ...
                        <div scope="col" class="py-2 text-sm font-semibold text-gray-900 w-10/12">Name</div>
                    </div>
                            ...
                            <a class="flex w-full border-t border-gray-300 hover:cursor-pointer hover:bg-gray-50"
                                ...
                                <div class="flex w-1/2 items-center">
                                    ...
                                    <div class="py-2 text-sm text-gray-900 w-4/12 text-center relative">
                                        {{ $player->frames_won }}
                                        <span class="items-center rounded-md bg-green-100 px-1 text-[10px] font-semibold text-green-700 absolute left-full -translate-x-1/2">
