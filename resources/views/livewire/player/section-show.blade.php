<section>
    <div class="bg-white shadow-sm sm:rounded-lg flex flex-col h-full overflow-hidden -mx-4 sm:mx-0 dark:bg-zinc-900/75 dark:shadow-none dark:ring-1 dark:ring-white/5">
