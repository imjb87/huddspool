                                        ...
                                        <div class="flex items-center gap-4 py-4" wire:key="account-history-{{ $entry['season_id'] }}-{{ $entry['section_id'] }}-{{ md5((string) $entry['team_name']) }}">
                                            ...
                                            <div class="ml-auto flex shrink-0 items-start gap-3 self-center text-center">
                                                ...
                                                <div class="w-16">
                                                    ...
                                                    <span class="mt-1 inline-flex items-center rounded-md bg-green-100 px-1.5 py-0.5 text-[10px] font-semibold text-green-700 dark:bg-green-950/50 dark:text-green-300">{{ $winPercentage }}%</span>
                                                </div>
                                                <div class="w-16">
                                                    <p class="text-xs font-medium text-gray-500 dark:text-gray-400">Lost</p>
                                                    <p class="mt-1 text-sm font-semibold leading-5 text-red-700 dark:text-red-400">{{ $entry['losses'] }}</p>
                                                    <span class="mt-1 inline-flex items-center rounded-md bg-red-100 px-1.5 py-0.5 text-[10px] font-semibold text-red-700 dark:bg-red-950/50 dark:text-red-300">{{ $lossPercentage }}%</span>
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
