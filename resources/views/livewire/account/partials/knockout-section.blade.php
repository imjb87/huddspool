@if ($this->knockoutMatches->isNotEmpty())
    <section class="ui-section" data-account-knockout-section>
                                ...
                                <div class="ui-card-row items-start px-4 sm:items-center sm:px-5">
                                    <div class="min-w-0 flex-1">
                                        ...
                                        @if ($knockoutRow->is_doubles)
                                            <div class="space-y-0.5 text-sm leading-5 font-semibold text-gray-900 dark:text-gray-100">
                                                <p class="[overflow-wrap:anywhere]">
                                                    ...
                                                    <span class="px-1 font-normal text-gray-400 dark:text-neutral-500">vs</span>
                                                </p>
                                        ...
                                        <p class="mt-1 [overflow-wrap:anywhere] text-xs leading-5 text-gray-500 dark:text-gray-400">
                                            <span>Venue: </span>
                                            <span>{{ $knockoutRow->venue_label }}</span>
                                        </p>

                                        @if ($knockoutRow->referee_label)
