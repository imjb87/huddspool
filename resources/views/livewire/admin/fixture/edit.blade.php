                        ...
                        @foreach ($schedule as $week => $fixtures)
                            ...
                            @foreach ($fixtures as $id => $fixture)
                                <tr class="border-t border-gray-300">
                                    ...
                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                        <button type="button"
                                            class="rounded-md bg-amber-600 px-3 py-2 text-center text-sm font-semibold text-white shadow-sm hover:bg-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600 inline-flex items-center gap-x-2"
