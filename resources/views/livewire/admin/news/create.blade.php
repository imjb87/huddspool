        ...
        <form class="divide-y-slate-200 mt-6 space-y-8 divide-y" wire:submit="save">
            <div class="grid grid-cols-1 gap-y-6 pt-8 sm:grid-cols-6 sm:gap-x-6">
                ...
                <div class="sm:col-span-6">
                    ...
                    <input type="text" name="title" id="title"  wire:model="news.title"
                ...
                <div class="sm:col-span-6">
                    ...
                    <textarea class="mt-2 block w-full rounded-md border-0 py-1.5 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-blue-500 sm:text-sm sm:leading-6" id="content" name="content" wire:model="news.content" rows="5"></textarea>
                </div>
