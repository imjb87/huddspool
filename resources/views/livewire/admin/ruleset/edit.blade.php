<div class="flex-1 xl:overflow-y-auto">
    <div class="mx-auto max-w-3xl py-10 px-4 sm:px-6 lg:py-12 lg:px-8">
        <h1 class="text-3xl font-bold tracking-tight text-slate-900">Edit Ruleset</h1>
        @if ($errors->any())
            <x-errors />
        @endif
        <form class="divide-y-slate-200 mt-6 space-y-8 divide-y" wire:submit="save">
            <div class="grid grid-cols-1 gap-y-6 pt-8 sm:grid-cols-6 sm:gap-x-6">
                ...
                <div class="sm:col-span-6">
                    ...
                    <input type="text" name="name" id="name" autocomplete="name" wire:model.live="ruleset.name"
                ...
                <div class="sm:col-span-6">
                    ...
                    <x-tiny-mce content="ruleset.content" name="content" id="content">{!! $ruleset->content !!}</x-tiny-mce>
                </div>

            </div>

            <div class="flex gap-x-3 pt-8 justify-end">
                <a href="{{ route('admin.rulesets.show', $ruleset) }}"
