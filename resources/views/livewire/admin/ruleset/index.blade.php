<div class="px-4 sm:px-6 lg:px-8">
    <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
            <h1 class="text-base font-semibold leading-6 text-gray-900">Rulesets</h1>
            <p class="mt-2 text-sm text-gray-700">A list of all the rulesets.</p>
        </div>
        <div class="mt-4 sm:mt-0 sm:ml-4 sm:flex-none">
            <a href="{{ route('admin.rulesets.create') }}"
            ...
            <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                    ...
                    <div class="overflow-hidden bg-white shadow sm:rounded-md">
                        <ul role="list" class="divide-y divide-gray-200">
                            @foreach ($rulesets as $ruleset)
                                <li>
                                    <a class="block hover:bg-gray-50" href="{{ route('admin.rulesets.show', $ruleset) }}">
                ...
                @else
                    <a href="{{ route('admin.rulesets.create') }}"
                        ...
                        <span class="mt-2 block text-sm font-semibold text-gray-900">Add ruleset</span>
                    </a>
                @endif
            </div>
        </div>
