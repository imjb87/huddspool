<div class="flex-1 xl:overflow-y-auto">
    <div class="mx-auto max-w-3xl py-10 px-4 sm:px-6 lg:py-12 lg:px-8 min-h-screen">
        <h1 class="text-3xl font-bold tracking-tight text-slate-900">Add Expulsion</h1>
        @if ($errors->any())
            <x-errors />
        @endif
            ...
            <div class="grid grid-cols-1 gap-y-6 pt-8 sm:grid-cols-6 sm:gap-x-6">
                ...
                <div class="sm:col-span-6">
                    ...
                    <select name="expellable_type" id="expellable_type" wire:model="expellable_type"
                        ...
                        <option value="App\Models\User">Player</option>
                    </select>
                </div>
