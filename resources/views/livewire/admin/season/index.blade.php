            ...
            <div class="inline-block min-w-full max-w-full py-2 align-middle sm:px-6 lg:px-8">
                                ...
                                @foreach ($seasons as $season)
                                    <tr>
                                        ...
                                        <td
                                            ...
                                            <a class="rounded bg-indigo-600 px-2 py-1 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600" href="{{ route('admin.seasons.show', $season) }}">View</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
                ...
                @else
                    <a href="{{ route('admin.seasons.create') }}"
                        ...
                        <span class="mt-2 block text-sm font-semibold text-gray-900">Add season</span>
                    </a>
                @endif
            </div>
        </div>
