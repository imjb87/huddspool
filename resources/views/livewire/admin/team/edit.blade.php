        ...
        <form class="divide-y-slate-200 mt-6 space-y-8 divide-y" wire:submit="save">
            <div class="grid grid-cols-1 gap-y-6 pt-8 sm:grid-cols-6 sm:gap-x-6">
                ...
                <div class="sm:col-span-6">
                    ...
                    <input type="text" name="name" id="name" autocomplete="name" wire:model.live="team.name"
                ...
                <div class="sm:col-span-6">
                    ...
                    <input type="text" name="shortname" id="shortname" autocomplete="shortname" wire:model.live="team.shortname"
                        class="mt-2 block w-full rounded-md border-0 py-1.5 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-blue-500 sm:text-sm sm:leading-6" />
                </div>

                <div class="sm:col-span-6">
                    <label for="venue_id" class="block text-sm font-medium leading-6 text-slate-900">Venue</label>
                    <x-select wire:model.live="team.venue_id" id="venue_id" name="venue_id">
                ...
                <div class="sm:col-span-6">
                    ...
                    <select name="captain_id" id="captain_id" wire:model.live="team.captain_id" class="mt-2 block w-full rounded-md border-0 py-1.5 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-blue-500 sm:text-sm sm:leading-6">
