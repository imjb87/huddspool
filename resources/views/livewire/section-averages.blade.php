<section data-section-averages-view class="mt-0">
    ...
    @endphp
    <div class="w-full overflow-hidden border-y border-gray-200 bg-white shadow-md dark:border-zinc-800/80 dark:bg-zinc-900/75 dark:shadow-none dark:ring-1 dark:ring-white/5" data-section-averages-shell>
        <div class="min-w-full overflow-hidden">
            ...
            <div class="bg-white dark:bg-zinc-900/75" wire:loading.remove wire:target="previousPage, nextPage">
                @if ($players->isEmpty())
            ...
            <div class="animate-pulse bg-white dark:bg-zinc-900/75" wire:loading.block wire:target="previousPage, nextPage" data-section-averages-row-skeleton>
