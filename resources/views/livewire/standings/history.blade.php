<section data-history-standings-view>
    <div class="grow-0 overflow-hidden bg-white shadow-sm sm:rounded-lg -mx-4 flex h-full flex-col sm:mx-0 dark:bg-neutral-900/75 dark:shadow-none dark:ring-1 dark:ring-white/5">
        ...
        <div class="flex h-full flex-col border-t border-gray-200 dark:border-neutral-800/80">
            <div class="min-w-full overflow-hidden">
                <div class="flex bg-gray-50 dark:bg-neutral-900/70">
                ...
                <div class="bg-white dark:bg-transparent">
                    ...
                    @else
                        ...
                        @foreach ($standingRows as $row)
                            <a class="flex w-full rounded-xl px-4 transition hover:cursor-pointer hover:bg-gray-200/70 dark:hover:bg-neutral-900/70 sm:-mx-6 sm:px-6 {{ $row->withdrawn ? 'line-through' : '' }}"
