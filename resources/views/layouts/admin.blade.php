                                ...
                                <nav class="space-y-1 px-2">
                                    ...
                                    <a href="{{ route('admin.teams.index') }}"
                                        ...
                                        <svg fill="currentColor"
                                            class="text-gray-400 group-hover:text-gray-300 mr-4 h-6 w-6 flex-shrink-0"
