...
<header class="site-header fixed top-0 z-50 w-full bg-white shadow-lg transition-all duration-500 dark:border-b dark:border-zinc-800/80 dark:bg-zinc-900/95 dark:backdrop-blur"
    x-data="{
        open: false,
        activeDrawer: 'root',
        headerHeight: 0,
    ...
    x-init="syncTheme(); updateHeaderHeight(); window.addEventListener('resize', () => updateHeaderHeight()); window.addEventListener('site-theme-changed', () => syncTheme())"
    x-ref="header">
            ...
            <div class="relative h-full overflow-hidden bg-white dark:bg-zinc-950">
                    ...
                    <div class="space-y-6">
                        <div class="space-y-3">
                            @foreach ($rulesets as $ruleset)
                                ...
                                @continue($navigableSections->isEmpty())
                                <button type="button"
                                    class="flex w-full items-center justify-between rounded-lg px-3 py-3 text-left text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50 dark:text-gray-100 dark:hover:bg-zinc-900"
                        ...
                        <div class="space-y-2 border-t border-gray-200 pt-4 dark:border-gray-800">
                            ...
                            <a href="{{ route('history.index') }}"
                                class="block rounded-lg px-3 py-3 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50 dark:text-gray-100 dark:hover:bg-zinc-900">
                                History
                            </a>
                            <a href="{{ route('page.show', 'handbook') }}"
                                class="block rounded-lg px-3 py-3 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50 dark:text-gray-100 dark:hover:bg-zinc-900">
                        ...
                        <div class="space-y-2 border-t border-gray-200 pt-4 dark:border-gray-800">
                            @if (@auth()->user())
                                <span class="block px-3 text-sm font-semibold leading-7 text-gray-500 dark:text-gray-400">{{ auth()->user()->name }}</span>
                                <a href="{{ route('account.show') }}"
                                    class="block rounded-lg px-3 py-3 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50 dark:text-gray-100 dark:hover:bg-zinc-900">
                                    Account
                                </a>
                ...
                @foreach ($rulesets as $ruleset)
                    ...
                    <div class="absolute inset-0 overflow-y-auto bg-white px-4 py-5 dark:bg-zinc-950"
                        ...
                        <div class="space-y-6">
                            <button type="button"
                                class="block w-full rounded-lg px-3 py-3 text-left text-base font-semibold leading-7 text-gray-500 hover:bg-gray-50 dark:text-gray-400 dark:hover:bg-zinc-900"
                                @click="goBackToRoot()">
