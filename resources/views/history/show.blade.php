        ...
        <div class="mx-auto max-w-7xl px-4 lg:px-8">
            <div class="border-b border-gray-200 pb-2 mb-4">
                <div class="-ml-2 -mt-2 flex flex-wrap items-baseline">
                    <h1 class="ml-2 mt-2 text-base font-semibold leading-6 text-gray-900 dark:text-gray-100">
                        {{ $season->name }}
                    </h1>
                    <p class="ml-2 mt-1 truncate text-sm text-gray-500 dark:text-gray-400">
                        {{ $ruleset->name }}
                    </p>
                </div>
            </div>
            <div class="grid grid-cols-1 gap-x-6 gap-y-6 lg:grid-cols-2">
                ...
                @empty
                    <div class="lg:col-span-2">
                        <div class="rounded-lg border border-dashed border-gray-300 p-6 text-center text-sm text-gray-500 dark:border-zinc-700 dark:text-gray-400">
