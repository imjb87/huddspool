    ...
    <div class="w-full overflow-hidden border-y border-gray-200 bg-white shadow-md">
        <div class="bg-linear-to-b from-gray-50 to-gray-100">
            <div class="mx-auto flex w-full max-w-4xl">
                <div class="w-[41%] py-2 pl-4 text-right sm:pl-6">
                    <div class="ml-auto h-4 w-12 rounded-full bg-gray-200"></div>
                </div>
                <div class="w-[18%] px-1 py-2 text-center">
                    <div class="mx-auto h-4 w-8 rounded-full bg-gray-200"></div>
                </div>
        ...
        <div class="border-b border-gray-300 bg-white">
            @foreach (range(1, 5) as $row)
                <div class="border-t border-gray-300" data-section-tab-skeleton-row="fixtures-results">
    ...
    <div class="mx-auto w-full max-w-4xl px-4 py-4 sm:px-6 lg:px-6 lg:py-6">
        <div class="flex w-full">
            ...
            <div class="flex w-[41%] justify-end">
                <div class="h-10 w-16 rounded-full bg-gray-200"></div>
            </div>
        </div>
    </div>
</section>
