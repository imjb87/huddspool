    ...
    <div class="bg-gray-50 pt-[72px]">
        <div class="pb-10 lg:pb-14" data-result-create-page>
            <div class="mx-auto flex w-full max-w-4xl items-end justify-between gap-3 px-4 pt-6 pb-4 sm:px-6 lg:px-6 lg:pt-7 lg:pb-4"
                ...
                <div class="min-w-0">
                    <h1 class="text-lg font-semibold text-gray-900">Submit a result</h1>
                ...
                <div class="space-y-6">
                    <section class="py-1" data-result-create-info-section>
                        <div class="grid gap-8 lg:grid-cols-3 lg:gap-10">
                            <div class="space-y-2">
                                <h3 class="text-sm font-semibold text-gray-900">Fixture details</h3>
                            ...
                            <div class="space-y-5 lg:col-span-2">
                                <div class="rounded-lg border border-amber-200 bg-amber-50 px-4 py-3.5">
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="min-w-0">
                                            <h2 class="text-sm font-semibold text-amber-900">Automatic saving in progress</h2>
                                            <div class="mt-1.5 space-y-1.5 text-sm leading-6 text-amber-800">
                                ...
                                <div class="grid gap-x-6 gap-y-5 sm:grid-cols-2">
                                    ...
                                    <div>
                                        ...
                                        @if ($fixture->venue)
                                            <a class="mt-2 inline-flex text-sm font-semibold text-gray-700 underline decoration-gray-300 underline-offset-3 transition hover:text-gray-900 hover:decoration-gray-500"
                    ...
                    <section class="border-t border-gray-200 pt-6" data-result-create-form-section>
                        <div class="space-y-2">
                            <h3 class="text-sm font-semibold text-gray-900">Result card</h3>
